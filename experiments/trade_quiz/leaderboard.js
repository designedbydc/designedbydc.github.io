// Leaderboard and Challenge System for Trade Quiz
...
function showLeaderboard() {
    ...
    modal.innerHTML = `
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 max-w-md mx-4 shadow-lg">
            <div class="flex justify-between items-center mb-4">
                ...
                <button id="close-leaderboard" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300">
            ...
            <button id="dismiss-leaderboard" class="mt-6 w-full py-2 px-4 bg-gray-500 hover:bg-gray-600 text-white rounded-lg transition-colors">
                Close
            </button>
        </div>
    `;
    ...
    document.getElementById('dismiss-leaderboard').addEventListener('click', () => {
        modal.remove();
    });
    ...
    document.getElementById('dismiss-leaderboard').focus();
}

// Function to add leaderboard button to the UI
function addLeaderboardButton() {
    const container = document.createElement('div');
    container.className = 'fixed top-4 right-4 z-10';
    
    const button = document.createElement('button');
    button.id = 'leaderboard-button';
    button.className = 'p-2 bg-purple-600 hover:bg-purple-700 text-white rounded-full shadow-lg transition-colors';
    button.setAttribute('aria-label', 'View Leaderboard');
    button.innerHTML = `
        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
function createChallengeLink(score, correctAnswers, incorrectAnswers) {
...
function showChallengeModal(score, correctAnswers, incorrectAnswers) {
    ...
    const challengeLink = createChallengeLink(score, correctAnswers, incorrectAnswers);
